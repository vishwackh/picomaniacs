(function () {
    ...
    homePageCtrl.$inject = ['$scope', '$http', '$rootScope', 'localStorageService', 'toaster', '$state'];

    /* @ngInject */
    function homePageCtrl($scope, $http, $rootScope, localStorageService, toaster, $state) {
        var count=0;
        $scope.ldata = {};
        $scope.myFile = [];
        ...
        $scope.getImageList = function () {
            $http.get($rootScope.ApiUrl + 'homeImageList').then(function (data) {
                if (data) {
